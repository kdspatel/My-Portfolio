    ...
    <footer className="relative overflow-hidden bg-black">
        ...
        >
          ...
          <h1 className="font-semibold leading-none text-white text-center select-none"
            style={{
              fontSize : "clamp(3rem,5vw,14rem)", // Make responsive text
          ...
          {/* Line */}
          <div className="h-[3px] w-24 md:w-32 rounded-full bg-gradient-to-r from-blue-400 to-purple-500"/>
          ...
          <p className="text-xs text-gray-400">
            &copy; {new Date() .getFullYear()} Kajal Patel . All Rights Reserved
          </p>
